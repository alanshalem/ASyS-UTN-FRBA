...
x_t_b = rampa(3 * (t - 1)) - rampa(3 * (t - 2) + 2) + 2 * escalon(3 * (t - 3)) + escalon(3 * (t - 4));
x_t_c = rampa(-2 * (t - 1) + 1) - rampa(-2 * (t - 2) + 1) + 2 * escalon(-2 * (t - 3) + 1) + escalon(-2 * (t - 4) + 1);
x_t_d = rampa(((t - 1) / 2) -2) - rampa(((t - 2) / 2) - 2) + 2 * escalon((t - 3) / 2 - 2) + escalon(((t - 4) / 2) - 2);
